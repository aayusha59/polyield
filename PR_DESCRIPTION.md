...
This PR integrates **real-time Polymarket predictions** into Polyield, fetching live market data directly from Polymarket's Gamma API. Markets are now displayed on a dedicated `/markets` page with smart category detection, accurate prices, trading volumes, and market images.
